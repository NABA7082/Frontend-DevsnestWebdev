var words=["dora.jpg", "doremon.jpg", "mickey.jpg", "sponge.jpg", "shinchan.jpg", "nobita.jpg", "tom.jpg", "jerry.jpg"];
...
setInterval(() => {
    ...
    if(matches === 8){    
        document.querySelector(".popup").style.display="flex";
        document.querySelector(".container").style.display="none";
        document.querySelector(".popup > div > h2").innerHTML="Congratulations!!   You Won"
    }
}, 100);
